...
export const DEFAULT_TEMPLATES: QuizTemplate[] = [
  ...
  { id:"t4",  name:"3000 Must Know",      emoji:"📚",  desc:"คำศัพท์สำคัญ 30 คำ พร้อมคำใบ้",        config:{category:"top-3000",    size:30,  mode:"multiple-choice", hintsEnabled:true},  isGlobal:true, createdAt:"2025-01-01", playCount:312, tags:["essential","study"] },
